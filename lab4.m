...
f=fopen('C:\Users\User\Desktop\Лабы и расчеты\in15(5).txt','rt+') 
...
%{ПУНКТ №6------------------------------------------------------------------------------%}
f=fopen('C:\Users\User\Desktop\Лабы и расчеты\in15(5).txt');
M1=fscanf(f,'%g', [1 4]);
R1=fscanf(f,'%g', [1]);
M2=fscanf(f,'%g', [1 4]);
L1=fscanf(f,'%g', [1 4]);
...
File1NameExp='v01';
PictHigh1='200'; %высота рисунка на html-странице 8
...
% полученный графический файл необходимо разместить на htmlстранице 9
 %создается html-файл
